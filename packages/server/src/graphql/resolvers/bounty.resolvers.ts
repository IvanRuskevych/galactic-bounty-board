...
export const bountyResolvers = {
	Query: {
		...
		getCurrentUserBounties: (_p: unknown, _args: unknown, ctx: Context) =>
			bountyService.getCurrentUserBounties(ctx),
	},

	Mutation: {
		createBounty: (_p: unknown, args: MutationCreateBountyArgs, ctx: Context) =>
			bountyService.createBounty(args, ctx),

		updateBounty: (_p: unknown, args: MutationUpdateBountyArgs, ctx: Context) =>
			bountyService.updateBounty(args, ctx),

		deleteBounty: (_p: unknown, args: MutationDeleteBountyArgs, ctx: Context) =>
			bountyService.deleteBounty(args, ctx),

		postBounty: (_p: unknown, args: MutationPostBountyArgs, ctx: Context) => bountyService.postBounty(args, ctx),

		acceptBounty: (_p: unknown, args: MutationAcceptBountyArgs, ctx: Context) =>
			bountyService.acceptBounty(args, ctx),
	},
};
